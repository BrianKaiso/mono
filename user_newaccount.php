...
<div id="loginBox3">
<h2 class="mycenter">新規登録</h2>
<p class="mycenter">アカウントを作成するには、必要事項を記入して、<br />新規登録ボタンをクリックしてください。</p>
<!-- newacc_act.php はアカウント新規作成用のPHPです。 -->
<form id="newaccForm" action="#">
<p class="myright"><span>*は必須項目です。</span></p>
<fieldset class="first">
    <legend>ユーザー情報</legend>
        <dl><dt>お名前<span>*</span></dt><dd><input id="users_name" type="text" name="users_name" size="25" maxLength="25" oninput="isInCk(this)" /><span></span></dd></dl>
...
<div id="loginBox2">
<h2>ログイン</h2>
<p class="logad">アカウントをすでにお持ちですか？</p>
<p class="logad">こちらからアカウントにログインしましょう！</p>
<a id="accBtn" href="user_login.php">ログインする</a>
    ...
    if(Error.length > 0){
     ...
     // returnでajaxの処理を返す 
      ...
      if(result===false){
        ...
        window.location.href = 'user_login.php'; // login.phpに遷移し、成功メッセージを表示
        // caub4.insertAdjacentHTML('afterbegin', "<div class=\"cau2\">"); // エラーメッセージ前半部
